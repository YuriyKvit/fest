...
*/
    ...
    public List<ClanHall> getClanHalls1()
    {    
        //Set<Integer, ClanHall> = _clanHall.keySet();
        List<ClanHall> list = new ArrayList<ClanHall>(_clanHall.values());
        return list;
    }
