...
import com.festina.gameserver.model.actor.instance.L2ClanHallManagerInstance;
...
public class RequestBuyItem extends ClientBasePacket
{
	...
	void runImpl()
	{
        ...
        if (!player.isGM() && (target == null								// No target (ie GM Shop)
			    ...
			    && (!(target instanceof L2ClanHallManagerInstance))) || !player.isInsideRadius(target, L2NpcInstance.INTERACTION_DISTANCE, false, false))
        	return;
