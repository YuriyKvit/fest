...
import com.festina.gameserver.skills.Condition;
import com.festina.gameserver.skills.EffectTemplate;
import com.festina.gameserver.skills.Env;
import com.festina.gameserver.skills.Func;
import com.festina.gameserver.skills.FuncTemplate;
import com.festina.gameserver.skills.L2SkillCharge;
import com.festina.gameserver.skills.L2SkillChargeDmg;
import com.festina.gameserver.skills.L2SkillCreateItem;
import com.festina.gameserver.skills.L2SkillDefault;
import com.festina.gameserver.skills.L2SkillDrain;
import com.festina.gameserver.skills.L2SkillNegate;
import com.festina.gameserver.skills.L2SkillSeed;
import com.festina.gameserver.skills.L2SkillSummon;
...
public abstract class L2Skill
{
    ...
    public static enum SkillType {
        PDAM, MDAM, DOT, BLEED, POISON, HEAL, BALANCE_LIFE, HOT, COMBATPOINTHEAL, CPHOT, MANAHEAL, MANARECHARGE, MPHOT, AGGDAMAGE, BUFF, DEBUFF, STUN, ROOT, RESURRECT, PASSIVE, CONT, CONFUSION, UNLOCK, CHARGE
        (L2SkillCharge.class), SOW, HARVEST, FEAR, MHOT, DRAIN(L2SkillDrain.class), NEGATE(L2SkillNegate.class), CANCEL(
        ...
        switch (targetType)
        {
            ...
            case TARGET_ONE:
            {
            	...
            	if ((activeChar.getTarget() instanceof L2PcInstance)) {
            		trg = (L2PcInstance)activeChar.getTarget();
            	}
            	
            	if ((player != null) && (trg != null) && (((player.getParty() != null) && (trg.getParty() != null)) || (((player.getClan() != null) || (trg.getClan() != null)) && ((player.getClanId() == trg.getClanId()) || (player.getParty().getPartyLeaderOID() == trg.getParty().getPartyLeaderOID())))))
            	{
            		if (isDebuff(skillType))
            		{
    ...
    public boolean isDebuff(SkillType skillType) 
    {
    	if ((skillType == SkillType.BLEED) || (skillType == SkillType.POISON) || (skillType == SkillType.DEBUFF) || (skillType == SkillType.STUN) || (skillType == SkillType.ROOT) || (skillType == SkillType.CONFUSION) || (skillType == SkillType.FEAR) || (skillType == SkillType.CANCEL) || (skillType == SkillType.SLEEP) || (skillType == SkillType.DETECT_WEAKNESS) || (skillType == SkillType.DOT) || (skillType == SkillType.MDOT) || (skillType == SkillType.MUTE) || (skillType == SkillType.WEAKNESS) || (skillType == SkillType.PARALYZE) || (skillType == SkillType.DRAIN_SOUL))
    	{
    		return true;
    	}
    	return false;
