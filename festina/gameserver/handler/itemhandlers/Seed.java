...
//import com.festina.gameserver.model.actor.instance.L2BossInstance;
...
public class Seed implements IItemHandler {
    ...
    public void useItem(L2PlayableInstance playable, L2ItemInstance item) {
        ...
        if ( !(target instanceof L2MonsterInstance)  ||
            ...
            _activeChar.sendMessage("The target is unavailable for seeding");
            _activeChar.sendPacket(new ActionFailed());
            return;
        }
        ...
        if(areaValid(MapRegionTable.getInstance().getAreaCastle(_activeChar))) {
            ...
            _activeChar.sendMessage("The seed may not be sown here");
        }
    }
