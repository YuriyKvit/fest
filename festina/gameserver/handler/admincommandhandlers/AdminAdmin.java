...
public class AdminAdmin implements IAdminCommandHandler {
 ...
 private static String[] _adminCommands = {"admin_admin","admin_play_sounds","admin_play_sound",
                                           ...
                                           "admin_manualhero", "admin_admin2", "admin_admin3", "admin_admin4", "admin_admin5"};
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar) {
		...
		if (command.equals("admin_admin")) AdminHelpPage.showHelpPage(activeChar, "newadmin.htm");
	...
	public void showMainPage(L2PcInstance activeChar)
	{
		...
		replyMSG.append("<button value=\"New Admin Menu :)\" action=\"bypass -h admin_newadmin 0\" width=90 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">");
