 ...
 */
package com.festina.gameserver.gameserverpackets;

import java.io.IOException;

import com.festina.gameserver.LoginServerThread.SessionKey;
...
public class PlayerAuthRequest extends GameServerBasePacket
{
	...
	/* (non-Javadoc)
	 * @see com.festina.gameserver.gameserverpackets.GameServerBasePacket#getContent()
	 */
	@Override
