...
import com.festina.gameserver.skills.SkillsEngine;
...
public class ItemTable
{
    ...
    private static final String[] SQL_ITEM_SELECTS  =
    {
        ...
        "SELECT item_id, name, bodypart, crystallizable, armor_type, weight, material, crystal_type, avoid_modify, durability, p_def, m_def, mp_bonus, price, crystal_count, sellable, item_skill_id, item_skill_lvl FROM armor",
        "SELECT item_id, name, bodypart, crystallizable, weight, soulshots, spiritshots, material, crystal_type, p_dam, rnd_dam, weaponType, critical, hit_modify, avoid_modify, shield_def, shield_def_rate, atk_speed, mp_consume, m_dam, durability, price, crystal_count, sellable, pasive_skill_id, pasive_skill_level FROM weapon"
    };
    /** List of etcItem */
    ...
    private Item readWeapon(ResultSet rset) throws SQLException
    {
        ...
        item.set.set("pasive_skill_id", rset.getInt("pasive_skill_id"));
        item.set.set("pasive_skill_level", rset.getInt("pasive_skill_level"));
