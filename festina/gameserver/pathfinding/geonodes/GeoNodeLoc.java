...
public class GeoNodeLoc extends AbstractNodeLoc
{
	...
	/**
	 * @see com.festina.gameserver.pathfinding.AbstractNodeLoc#getX()
	 */
	@Override
	public int getX()
	{
	...
	/**
	 * @see com.festina.gameserver.pathfinding.AbstractNodeLoc#getY()
	 */
	@Override
	public int getY()
	{
	...
	/**
	 * @see com.festina.gameserver.pathfinding.AbstractNodeLoc#getZ()
	 */
	@Override
	public short getZ()
	{
